...
func (c *helloWorldProtobufClient) Speak(ctx context.Context, in *Words) (*Words, error) {
	url := c.urlBase + HelloWorldPathPrefix + "Speak"
	out := new(Words)
...
func (c *helloWorldJSONClient) Speak(ctx context.Context, in *Words) (*Words, error) {
	url := c.urlBase + HelloWorldPathPrefix + "Speak"
	out := new(Words)
...
func (s *helloWorldServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "us.xeserv.api")
	...
	switch req.URL.Path {
	case "/twirp/us.xeserv.api.HelloWorld/Speak":
		s.serveSpeak(ctx, resp, req)
		return
	default:
...
func (s *helloWorldServer) serveSpeak(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	switch req.Header.Get("Content-Type") {
	case "application/json":
		s.serveSpeakJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveSpeakProtobuf(ctx, resp, req)
	default:
...
func (s *helloWorldServer) serveSpeakJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Speak")
	...
	func() {
		...
		respContent, err = s.Speak(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Words and nil error while calling Speak. nil responses are not supported"))
		return
	}
...
func (s *helloWorldServer) serveSpeakProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Speak")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
